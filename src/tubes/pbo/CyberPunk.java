 ...
 */
public class CyberPunk extends javax.swing.JFrame {

    /**
     * Creates new form CyberPunk
     */
    public CyberPunk() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Harits Rahman\\Downloads\\cyberpunk_2077_gif.gif")); // NOI18N
        ...
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 179, Short.MAX_VALUE)
        );
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        else if(gpu==1&&cpu==1&&ram==0){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==1&&cpu==5&&ram==0){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        ...
        else if(gpu==1&&cpu==1&&ram==1){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==1&&cpu==5&&ram==1){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        ...
        else if(gpu==1&&cpu==1&&ram==2){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==1&&cpu==5&&ram==2){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==4&&ram==0){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==1&&ram==0){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==5&&ram==0){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==1&&ram==1){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==1&&ram==2){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==5&&ram==1){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
        else if(gpu==0&&cpu==5&&ram==2){
            JOptionPane.showMessageDialog(this,"your Graphic card(GPU), Processor(CPU),and memory RAM did not meet the requirement", "CHECK",JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CyberPunk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
